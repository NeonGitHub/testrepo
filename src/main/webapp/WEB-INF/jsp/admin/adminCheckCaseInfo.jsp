			...
			<div class="col-xs-12 col-sm-9">
				<div class="discuss">
					<ul class="nav nav-tabs">
						<li role="presentation"><a href="#">查看所有案例</a></li>
						<li role="presentation"><a href="#">添加治愈案例</a></li>
						<li role="presentation" class="active"><a href="#">审核治愈案例</a></li>
					</ul>
				</div>
				<div class="col-md-12">
					<h3>审核案例</h3>
				...
				<div class="myAtreat">
					<form action="/graProject/admin/passCheckCase2">
						...
						<div class="col-md-3 col-md-offset-5">
							...
							<button type="button" onclick="window.location.href = '/graProject/admin/deleteCheckCase/${treatment.caseId}'" class="btn btn-danger">拒绝</button>
						</div>
					</form>
				</div>
				<!--mytreat-->
