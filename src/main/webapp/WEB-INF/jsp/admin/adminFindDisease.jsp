			...
			<div class="col-xs-12 col-sm-9">
				<div class="discuss">
					<ul class="nav nav-tabs">
						<li role="presentation" class="active"><a href="#">查看所有疾病</a></li>
						<li role="presentation"><a href="/graProject/admin/addDisease">添加疾病种类</a></li>
					</ul>
				</div>
				...
				<div class="row" style="padding: 15px">
					...
					<div class="col-md-4 col-md-offset-4">
						...
						<ul class="pagination">
							<li><a href="/graProject/admin/findDisease?page=1&pageSize=${pageSize}"
									aria-label="First">
									<span aria-hidden="true">&laquo;</span>
								</a></li>
							<c:forEach var="i" begin="1" end="${totalPage}">
								<li><a href="/graProject/admin/findDisease?page=${i}&pageSize=${pageSize}">
										<c:out value="${i}" />
									</a></li>
							</c:forEach>
							<li><a href="/graProject/admin/findDisease?page=${totalPage}&pageSize=${pageSize}"
									aria-label="Last">
