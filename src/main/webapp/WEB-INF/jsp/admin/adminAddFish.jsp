			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"
					...
					<ul class="dropdown-menu">
						<li><a href="/graProject/admin/${seesionScope.user.userId}?page=1&pageSize=10">查看疾病种类</a></li>
			...
			<div class="col-xs-12 col-sm-9">
				<div class="discuss">
					<ul class="nav nav-tabs">
						<li role="presentation"><a href="/graProject/admin/findFish?page=1&pageSize=10">查看所有生物</a></li>
						<li role="presentation" class="active"><a href="#">添加生物种类</a></li>
					</ul>
				</div>
				...
				<div class="row" style="padding: 15px">
					...
					<form action="/graProject/admin/addFish2" method="post">
						...
						<div class="myBselect">
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" name="fishName" class="form-control" style="width: 220px">
									</div>
								</div>
							</div>
							<br>
				...
				<div class="list-group">
					...
					<div class="dropdown">
						...
						<ul class="dropdown-menu" style="width: 100%">
							<li class="text-center"><a href="/graProject/admin/caseList?page=1&pageSize=10">查看疾病种类</a></li>
					...
					<div class="dropdown">
						...
						<ul class="dropdown-menu" style="width: 100%">
							...
							<li class="text-center"><a href="/graProject/admin/checkCase?page=1&pageSize=10">审核治愈案例</a></li>
						</ul>
					</div>
