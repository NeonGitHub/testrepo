			...
			<div class="col-xs-12 col-sm-9">
				<div class="discuss">
					<ul class="nav nav-tabs">
						<li role="presentation"><a href="#">更改疾病情况</a></li>
					</ul>
				</div>

				<div class="row">

					<form action="/graProject/admin/updateDisease2" method="post">
						<div class="col-md-12">
							<h3>更改基本信息</h3>
						</div>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-4">
										...
										<input type="text" name="diseaseName" class="form-control" style="width: 220px"
											value="${diseaseCase.diseaseName}">
									</div>
								</div>
							</div>
							<br>
