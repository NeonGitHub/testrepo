			...
			<div class="col-xs-12 col-sm-9">
				...
				<div class="row" style="padding: 15px">
					...
					<table class="table">
						...
						<c:forEach items="${fishList}" var="fish">
							<tr>
								<td>${fish.fishId}</td>
								<td>${fish.fishName}</td>
								<td><button type="button" class="btn btn-danger" onclick="window.location.href = '/graProject/admin/deleteFish/${fish.fishId}'">删除</button></td>
							</tr>
						</c:forEach>
					</table>
					...
					<div class="col-md-4 col-md-offset-4">
						...
						<ul class="pagination">
							<li><a href="/graProject/admin/findFish?page=1&pageSize=${pageSize}"
									aria-label="First">
									<span aria-hidden="true">&laquo;</span>
								</a></li>
							<c:forEach var="i" begin="1" end="${totalPage}">
								<li><a
										href="/graProject/admin/findFish?page=${i}&pageSize=${pageSize}">
										<c:out value="${i}" />
									</a></li>
							</c:forEach>
							<li><a
									href="/graProject/admin/findFish?page=${totalPage}&pageSize=${pageSize}"
									aria-label="Last">
