		...
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<div class="col-xs-12 col-sm-9">
				...
				<div class="row" style="padding: 15px">
					...
					<form action="/graProject/admin/updateBehave2" method="post">
						...
						<div class="myBselect">
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" name="behaveId" class="form-control" readonly="readonly" style="width: 220px" value="${behave.behaveId}">
									</div>
								</div>
							</div>
							<br>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" name="behaveDesc" class="form-control" style="width: 220px" value="${behave.behaveDesc}">
									</div>
								</div>
							</div>
							<br>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" name="behavePart" class="form-control" style="width: 220px" value="${behave.behavePart}">
									</div>
								</div>
							</div>
							<br>
							...
							<div class="row">
								<div class="form-group">
									...
									<div class="col-md-4">
										<input type="text" name="behaveValue" class="form-control" style="width: 220px" value="${behave.behaveValue}">
									</div>
								</div>
							</div>
							<br>
