		...
		<div class="row row-offcanvas row-offcanvas-right">
			...
			<div class="col-xs-12 col-sm-9">
				...
				<div class="discuss">
					<ul class="nav nav-tabs">
						<li role="presentation" class="active"><a href="#">案例展示</a></li>
					</ul>
				</div>
				<div class="col-md-12">
					<h3>诊断情况</h3>
			...
			<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar">
				...
				<div class="list-group">
					...
					<a href="/graProject/caseList?page=1&pageSize=10" class="list-group-item text-center active">查看案例</a>
